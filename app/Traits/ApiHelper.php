...
trait ApiHelper
{
    ...
    protected function prepareTileUpdateData(array $product, $creation_time,$imageFileName,$excludeName = "false"){
        ...
        $data = [
            ...
            'color' => $product['color'] ?? null,
            'poc' => $product['poc'] ?? null,
            'thickness' => isset($product['thickness']) && $product['thickness'] !== '' ? number_format((float) $product['thickness'], 2, '.', '') : null,
            'tiles_per_carton' => isset($product['tiles_per_carton']) && $product['tiles_per_carton'] !== '' ? (int) $product['tiles_per_carton'] : null,
            'avg_wt_per_carton' => $product['avg_wt_per_carton'] ?? null,
            'coverage_sq_ft' => $product['coverage_sq_ft'] ?? null,
            'coverage_sq_mt' => $product['coverage_sq_mt'] ?? null,
            'pattern' => $product['pattern'] ?? null,
