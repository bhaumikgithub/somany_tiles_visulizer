...
(function () {
    ...
    (function () {
        ...
        this.createTileLi = function () {
            ...
            var $li = $('<li id="tile_' + this.index + '" data-index="' + this.index + '" data-surface="' + this.surface + '"  data-tile="' + this.id + '" class="' + liClass + '" style="display: none;" onclick="getTileId(this.id)"></li>').click(selectTile).append($imageHolder, $tileText);
