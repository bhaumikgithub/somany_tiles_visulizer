...
(function () {
    ...
    function UI(room) {
        ...
        function getSurfaceGroups(surfaces) {
            ...
            surfaces.forEach(function (surface) {
                ...
                console.log("Surfaces CALLING");
                console.log(surface);
                if (!surface.group || groupIds.indexOf(surface.group) === -1) {
                    console.log("surface push : " + surface.group);
    ...
    UI.updateCanvasStyle = function (title) {
        ...
        console.log("updateCanvasStyle = " + title);
        ...
        _createClass(Loader, [{
            ...
            value: function _onWholeDataLoaded(part, data) {
                ...
                if (wholeDataLoaded && typeof this.onLoad === 'function') {
                    ...
                    console.log("Surfaced details");
                    var surfaceJSON = $.parseJSON(this.data.roomData["surfaces"]);

                    for(var i = 0;i<surfaceJSON.length;i++){
                        console.log("176 = " + surfaceJSON[i]["176"]);
                        console.log("group = " +  surfaceJSON[i]["group"]);
                    }
                ...
                if (this.data.roomSettings && Array.isArray(this.data.roomSettings.surfaces)) {
                    ...
                    this.data.roomSettings.surfaces.forEach(function (surface) {
                        ...
                        if (surface) {
                            ...
                            console.log("surface tileId " + surface.tileId);
                            console.log("surface tileCustom " + surface.tileCustom);
