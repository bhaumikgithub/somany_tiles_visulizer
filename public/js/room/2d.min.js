                ...
                if (typeof this._filterCallback === 'function') {
                    ...
                    if (this._activeTab === this._tabAll) {
                        ...
                        var activeCheckBoxes = this._activeTab.children.filter(function (checkBox) {
                            ...
                            console.log("MAP checkBox.id" + checkBox.id);
                            return checkBox.id;
    ...
    var Filter = function () {
        ...
        _createClass(Filter, [{
            ...
            value: function createDomElement() {
                ...
                this._body.id = '-body_' + Locale.lang(this.name);
    ...
    var Filters = function () {
                    ...
                    switch (filterOptions.type) {
                        ...
                        case FilterType.Checkbox:
                            ...
                            filter = new CheckboxFilter(filterOptions, _this32._tiles, function () {
                                console.log("_init = Case Checkbox");
        ...
        },         
        {
            ...
            value: function _filterTilesList() {
                ...
                if(totalFilterCheckboxesChecked(_this33._categories)==0){
                    forceSelectAll = true;
                }
                //EMD
                this._tiles.forEach(function (tile) {
