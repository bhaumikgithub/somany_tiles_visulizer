...
(function () {
                ...
                this._tiles.forEach(function (tile) {
                    ...
                    if (tile.surface === _this18.surface) {
                        ...
                        if (_this18.field === 'size') {
                            ...
                            tile[_this18.field] = tile.height + 'x' + tile.width;
    ...
    var Filters = function () {
        ...
        _createClass(Filters, [{
            ...
            value: function _matchFields(tile) {
                ...
                var brand = tile.brand ? tile.brand.toLowerCase() : '';
                var sub_brand = tile.sub_brand ? tile.sub_brand.toLowerCase() : '';

                if (name.indexOf(this._searchWord) !== -1 || 
                    category.indexOf(this._searchWord) !== -1 ||
                    brand.indexOf(this._searchWord) !== -1 || 
                    sub_brand.indexOf(this._searchWord) !== -1) {
                    return true;
                }
            ...
            // }
            {
                ...
                value: function _filterTilesList() {
                    ...
                    let matchedTiles = []; //Added By Kinjal-TPS
                    this._tiles.forEach(function (tile) {
                        if (tile.li.rotoHidden || tile.li.dataset.hidden === 'hidden' || tile.removed) {
                            return;
                        }
                        ...
                        if ((correctSurface && match && matchCategory) || tile.custom) {
                            ...
                            if (surfaceType === "wall") {
                                ...
                                visibleWallSizes.add(tile.height + "x" + tile.width);
                            }
                    ...
                    //Sort and show outside the loop
                    const sortedTiles = _this33._sortTilesByBrandPriority(matchedTiles);
            ...
            {
                key: '_sortTilesByBrandPriority',
                value: function _sortTilesByBrandPriority(tiles) {
                    const brandPriority = [
                        'coverstone',
                        'colorato collection',
                        'sedimento collection',
                        'porto collection',
                        'regalia collection',
                        'duragres',
                        'ceramica',
                    ...
                    return tiles.sort((a, b) => {
                        ...
                        const indexA = brandPriority.indexOf(brandA);
                        const indexB = brandPriority.indexOf(brandB);
    ...
    function Tile(tileData, index) {
        ...
        this.brand = tileData.brand; //Added by Kinjal-TPS

        this.sub_brand = tileData.sub_brand_1; //Added by Kinjal-TPS
    ...
    (function () {
        ...
        this.getInfoText = function () {
            ...
            // Condition to check if surface is "paint"
            var hideSize = this.surface === "paint";
            
        
            // var size = config.size && !hideSize ? '<p>' + Locale.lang('Size') + ': ' + this.width + 'mm x ' + this.height + 'mm</p>' : '';

            var size = config.size && !hideSize ? '<p>' + Locale.lang('Size') + ': ' + this.height + 'mm x ' + this.width + 'mm</p>' : '';
        ...
        this.createTileLi = function () {
            ...
            var $li = $('<li id="tile_' + this.index + '" data-index="' + this.index + '" data-surface="' + this.surface + '"  data-finish="' + this.finish + '"data-tile="' + this.id + '" class="' + liClass + '" style="display: none;" onclick="getTileId(this.id)"></li>').click(selectTile).append($imageHolder, $tileText);
    ...
    function productInfoAssText(tile, surfaceName, surfaceIndex) {
        ...
        var size = config.size ? Locale.lang('Size') + ': ' + tile.height + 'mm x ' + tile.width + 'mm\n' : '';
    ...
    window.addEventListener('load', function () {
        ...
        new Loader().loadRoom('/get/2d-studio/', function (data) {
