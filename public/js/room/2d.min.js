...
var Filter = function () {
    ...
    _createClass(Filter, [{
        ...
        value: function createDomElement() {
            // Create the filter block element
            this.domElement = document.createElement('div');
            this.domElement.className = 'filter-block';
            this.domElement.style.display = 'none'; // Initially hidden
            ...
            this._header.addEventListener('click', this.toggleTab.bind(this));
        ...
        value: function toggleTab() {
            // Get all headers in the filter block
            var allHeaders = document.querySelectorAll('#topPanelFilter .-header');

            // Loop through all headers and remove the 'active' class
            ...
            // Get all bodies that are inside the filter wrap
            var allBodies = document.querySelectorAll('#topPanelFilter .-body');

            // Loop through all bodies and hide them
            allBodies.forEach(function(body) {
                body.style.display = 'none';
            });

            // Show the body of the clicked filter and set its display to 'flex'
            if (this._body.style.display === 'none' || this._body.style.display === '') {
                this._body.style.display = 'flex'; // Change the display to flex when it's shown
                ...
                this._body.style.display = 'none'; // Hide the body if it is already visible
            }
...
////////////////////////////////////////////////////////
    ...
    var CheckboxFilter = function (_Filter) {
        ...
        _createClass(CheckboxFilter, [{
            ...
            value: function _getCheckboxFilterItem(name, value) {
                ...
                return { checked: true, domElement: undefined, name: name, value: value };
    ...
    var Filters = function () {
        ...
        function Filters(tiles, room, onLoad) {
            ...
            //console.log("productFilterSize");
            //console.log(JsConstants.config.productFilterSize);
            //console.log(JsConstants.config);
    ...
    var Room = function () {
        ...
        _createClass(Room, [{
            ...
            value: function _setPatternRotation(event) {
                ...
                console.log("this._isSurfaceSelected()");
                console.log(this._isSurfaceSelected());
                if (!this._isSurfaceSelected()) return;
