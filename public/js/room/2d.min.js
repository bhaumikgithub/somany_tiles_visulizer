        ...
        _createClass(Filters, [{
            ...
            // }
            {
                ...
                value: function _filterTilesList() {
                    ...
                    var addedTiles = new Set(); // To track already added tiles for counter
                    ...
                    this._tiles.forEach(function (tile) {
                        ...
                        // Check if the tile exists for multiple surfaces (Wall, Floor, Counter)
                        var isCounterTile = _this33._tiles.some(t => t.name === tile.name && t.surface === "counter");
                        var isWallTile = _this33._tiles.some(t => t.name === tile.name && t.surface === "wall");
                        var isFloorTile = _this33._tiles.some(t => t.name === tile.name && t.surface === "floor");

                        // Rule: Hide wall tiles ONLY if the tile ALSO exists in Counter for Kitchen/Bathroom
                        ...
                        // Allow wall and floor tiles for other rooms (Lobby, Reception, etc.)
                        ...
                        if ((correctSurface && match && matchCategory) || tile.custom) {
                            tile.show();
                            addedTiles.add(tileKey); // ✅ Store added tile for this surface type
