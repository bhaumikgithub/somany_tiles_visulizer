    ...
    var PanoramaTiledSurface = function (_TiledSurface) {
        ...
        _createClass(PanoramaTiledSurface, [{
        ...
        },//CODE BY TPS
            {
                ...
                value: function loadAndDrawForegroundImage(bigImage, jsonPath) {
                    ...
                    fetch(jsonPath)
                        ...
                        .then(json => {
                            // Check that json is valid before passing it to _render
                            if (json) {
                                var image = new Image();
                                image.onload = function () {
                                    if (tempThis._render) {
                                ...
                                console.error("Error: Received empty or invalid JSON");
                            }
