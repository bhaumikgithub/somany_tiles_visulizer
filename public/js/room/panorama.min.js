...
(function () {
    ...
    var Filter = function () {
        ...
        _createClass(Filter, [{
            ...
            value: function createDomElement() {
                ...
                this._headerBox.style.gap = '10px';
                this._headerBox.style.width = '100%';
                  // Optional: Add space between headers
    ...
    (function () {
        ...
        this.createTileLi = function () {
            ...
            this.li.dataset.tile = this.id; // Adding data-tile attribute // Added by Kinjal
    ...
    function UI(room) {
        ...
        function init() {
            ...
            $('#topPanelCloseBtn').click(_this.topPanelToggle); //Added By Kinjal
    ...
    var PanoramaTiledSurface = function (_TiledSurface) {
        ...
        function PanoramaTiledSurface(surfaceData, geometry, updateMask, stencilRef) {
            ...
            _this47._surfaceData = surfaceData; //Added BY TPS // Added by Kinjal
