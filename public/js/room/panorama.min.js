                ...
                this._tiles.forEach(function (tile) {
                    ...
                    if (tile.surface === _this11.surface) {
                        if (_this11.field === 'size') {
                            ...
                            tile[_this11.field] = tile.height + 'x' + tile.width;
                        }
        ...
        _createClass(Filters, [{
            ...
            value: function _find() {
                ...
                this._tiles.forEach(function (tile) {
                    ...
                    category.indexOf(_this18._searchWord) !== -1 ||
                    brand.indexOf(_this18._searchWord) !== -1 || 
                    sub_brand.indexOf(_this18._searchWord) !== -1) {
                        tile.hide();
                    } else {
                        tile.show();
                        foundTilesCount += 1;
                ...
                this._tiles.forEach(function (tile) {
                    ...
                    if ((correctSurface && match && matchCategory) || tile.custom) {
                        ...
                        if (surfaceType === "floor") {
                            ...
                            visibleFloorSizes.add(tile.height + "x" + tile.width);
                        }
                    } else {
                        tile.hide();
                        if (!tile.li.hidedByFilter) {
