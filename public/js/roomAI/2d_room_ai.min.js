...
//     $('#topPanelHideBtn').show();
//     landscapadjustPanelPosition();
//     if ($('#topPanelHideBtn').hasClass('glyphicon-menu-left')) {
//       $('#topPanelHideBtn')
//           .removeClass('glyphicon-menu-left')  // Remove the left icon
//           .addClass('glyphicon-menu-right');  // Add the right icon
//     }
//     var $mainPanel = $('.top-panel-product');
//     $mainPanel.css({
//       'position': 'fixed',        // Fixed position relative to the viewport
...
//       'height': (windowHeight ) + 'px', // Full viewport height minus 20px for spacing
//       'width': '450px',           // Set width to 300px
//       'right': '0px !important' ,          // Shift the panel 300px to the left (off-screen)
//       'border-top-right-radius': '0px' 
//   });
