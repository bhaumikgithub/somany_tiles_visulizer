...
var ws = new WebSocket("wss://67.211.222.179:8061");
...
(function () {
            ...
            },
            {
                ...
                value: function _showFoundTilesCount(searchWord, count) {
                    ...
                    if (searchWord) {
                        ...
                        if (count === 1) {
                            this._resultCountElement.innerHTML = Locale.lang(
                                "FILTER_FOUND_ONE_TILE"
                            );
                        } else if (count > 1) {
                            this._resultCountElement.innerHTML = Locale.lang(
                                "FILTER_FOUND_TILES",
                            ...
                            this._resultCountElement.innerHTML = Locale.lang(
                                "FILTER_TILES_NOT_FOUND"
                            );
                        }
                    } else if (
                        count === 0 &&
                        JsConstants.config.showAllUnfilteredProduct
                    ) {
                        this._resultCountElement.style.display = "";
            ...
            },
            {
                ...
                value: function _filterTilesList() {
                    ...
                    this._tiles.forEach(function (tile) {
                        ...
                        var correctSurface =
                            !tile.surface ||
                            tile.surface === _this33._room.currentTiledSurface.type;

                        var match = _this33._filterMatch(tile);

                        var matchCategory = _this33._categories
                            ? _this33._categories.match(
                                tile,
                                _this33._room.currentTiledSurface
                            )
                            : true;
    ...
    (function () {
        ...
        this.getInfoText = function () {
            ...
            if (config.style === "Client3") {
                var urlBtn = url
                    ? '<div class="-url"><p>Order Sample</p>' + url + "</div>"
                    : "";
        ...
        _createClass(Room, [
            ...
            },
            {
                ...
                value: function _setCheckFreeDesign(event) {
                    ...
                    var checked =
                        event && event.currentTarget && event.currentTarget.checked;
            ...
            },
            {
                ...
                value: function _initElements() {
                    ...
                    this._surfaceColorPicker = new ColorPicker(
                    ...
                    $("#shadow-menu").off();
                    $("#shadow-menu").on("change", function(){
                        _this41._setShadowIntensity(this.value / 100);
                    });
                },
            },
            {
                ...
                value: async function _setShadowIntensity(intensity) {
                    ...
                    const processed = processMaps(image, mask, shadowMap, reflectionMap, intensity)
                    ...
                    if (imageUrl) {
                        ...
                        img.onload = function () {
                            if (setSize) {
                                ...
                                // const [w, h] = limitSizeToBounds(_this44.width, _this44.height, window.innerWidth, window.innerHeight);
                                // _this44.width = w;
                                // _this44.height = h;
                            }
    ...
    function limitSizeToBounds(W, H, maxW, maxH) {
        const aspect = W / H;
        ...
        _createClass(TiledSurface2d, [
            ...
            },
            {
                ...
                value: function _init(roomData) {
                    ...
                    if (location.hash === "#test" || window.JsConstants.room.isDefault) {
                        ...
                        x3 = roomData.x4;
                        y3 = roomData.y4;
                        // translates the corner points so that the center of the view plane is at the origin (0, 0)
                        ...
                        this.projection._camera.near = f;
                        ...
                        m.makeBasis(
                            new window.THREE.Vector3(-x1, -y1, f),
                            new window.THREE.Vector3(x2, y2, -f),
                            new window.THREE.Vector3(-x3, -y3, f)
                        );

                        m.setPosition(new window.THREE.Vector3(x0, y0, -f));
                        ...
                        const P0 = new window.THREE.Vector3(x0, y0, -f).multiplyScalar(s);

                        const P1 = new window.THREE.Vector3(x1, y1, -f).multiplyScalar(
                            s * m.elements[12]
                        );

                        const P2 = new window.THREE.Vector3(x2, y2, -f).multiplyScalar(
                            s * m.elements[13]
                        );

                        const P3 = new window.THREE.Vector3(x3, y3, -f).multiplyScalar(
                            s * m.elements[14]
                        );
                        ...
                        this.projection._camera.far = Math.max(
                            ...
                            -3 * Math.min(P0.z, P1.z, P2.z, P3.z)
                        );
            ...
            },
            {
                ...
                value: function _fillSurface(tiles, drawEver) {
                    // let tile = tiles[0];

                    var tilesCount = this._getTilesCount(tiles[0]);
                    var tilesArray = [];
    ...
    var Room2d = (function (_Room) {
        ...
        function Room2d(data) {
            ...
            _this55._createSurfaces(data.roomData);
                ...
                value: function _restoreSettings(settings) {
                    ...
                    if (productName && typeof productName === "string") {
                        ...
                        TilesList.some(function (tile) {
                            ...
                            if (tileName === name) {
                                ...
                                if (!settings) {
                                    settings = {
                                        surfaces: Array(_this57.tiledSurfaces.length).fill(
                                            undefined
                                        ),
                                    };
                                }
                    ...
                    if (settings && Array.isArray(settings.surfaces)) {
                        settings.surfaces.forEach(function (surfaceSettings, index) {
                            if (
                                tile0 &&
                                _this57.tiledSurfaces[index].type === tile0.surface
                            ) {
                                if (surfaceSettings) {
            ...
            },
            {
                ...
                value: function _sceneMouseClick(event) {
                    ...
                    if (this.tiledSurfaces.length > 0) {
                        ...
                        var scrollWidth =
                            event && event.currentTarget && event.currentTarget.scrollWidth;

                        var scrollHeight =
                            event && event.currentTarget && event.currentTarget.scrollHeight;
    ...
    function processMaps(image, mask, sh_map, reflectMap, shadowIntensity) {
        ...
        const reflectData = context.getImageData(
            0,
            0,
            canvas.width,
            canvas.height
        ...
        const shadowData = context.getImageData(
            0,
            0,
            canvas.width,
            canvas.height
        ...
        for (let p = 0; p < imageData.data.length; p += 4) {
            ...
            const shadowM = (shadowIntensity * shadow + (1 - shadowIntensity) * 255) * m;
    ...
    function cropServerImage (image, aspect) {
    ...
    function uniqueID() {
        ...
        const uniqueID = parseInt((timestamp.toString() + randomNum.toString()) / 100) ;
        return uniqueID;
    }
    ...
    const handleImage = async function (image, fov, json, aspect) {
        ...
        const reflectCanvas = await dilateImage(json.reflect, serverWidth, serverHeight, [6,6]);
        ...
        mask = await loadImage(json.mask);

        const processed = processMaps(image, mask, sh_map, reflectImg, 0.6)
        ...
        // make it look like the data from /get/room2d/1 for now
        ...
        Object.assign(json, {
            ...
            type: "livingroom",
            icon: "/storage/rooms2d/room_icon_47.jpg",
        ...
        document
            ...
            .closest("a").style.pointerEvents = "none";
    };
            ...
            */
                        ...
                        ws.onmessage = function (e) {
                            ...
                            var output = {
                                ...
                                sh_map: "data:image/jpeg;base64," + input.shmap,
                            ...
                            console.log("Scaled & Ordered Points", {x1:output.x1, x2:output.x2, x3:output.x3, x4:output.x4,
                                y1:output.y1, y2:output.y2, y3:output.y3, y4:output.y4});
                        ...
                        // send to a websocket
                        ws.send(
                            JSON.stringify({id: uniqueID(), reflect_flag: '0', image: uploadedImage.split("base64,")[1] })
                        );
                    });
                };
            };
