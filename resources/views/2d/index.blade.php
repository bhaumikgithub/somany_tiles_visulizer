    ...
    <div class="onLoadWrapper" style="display: none;">
        <div class="container-fluid mt-2 desktop-div" style="padding-right: 2px;">
            ...
            <div class="grow hover_2">
                <a href="javascript:void(0);" onclick="fetchCategory('bedroom');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('kitchen');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('bathroom');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('prayer-room');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('outdoor');">
            ...
            <div class="grow hover_2">
                <a href="javascript:void(0);" onclick="fetchCategory('commercial');">
