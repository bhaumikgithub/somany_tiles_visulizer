...
@else
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <img id="form-room-theme-1-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
            <br>
            <img id="form-room-theme-thumbnail-1-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <img id="form-room-theme-2-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
            <br>
            <img id="form-room-theme-thumbnail-2-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <img id="form-room-theme-3-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
            <br>
            <img id="form-room-theme-thumbnail-3-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <img id="form-room-theme-4-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
            <br>
            <img id="form-room-theme-thumbnail-4-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <img id="form-room-theme-5-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
            <br>
            <img id="form-room-theme-thumbnail-5-img" src="" alt="" class="img-thumbnail" style="max-width: 128px; max-height: 128px;cursor: pointer;" onclick="showBigIconImageModal(window.$('#form-update-room-name').val(), this.src);">
        </div>
        <div class="col-sm-4">
