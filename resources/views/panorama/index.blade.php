    ...
    <div class="onLoadWrapper" style="display: none;">
        <div class="container-fluid mt-2 desktop-div" style="padding-right: 2px;">
            <div class="grow hover_1 first_width hover_2">
                <a href="{{url('/panorama-listing/livingroom')}}">
            ...
            <div class="grow hover_2">
                <a href="{{url('/panorama-listing/bedroom')}}">
            ...
            <div class="grow hover_2" >
                <a href="{{url('/panorama-listing/kitchen')}}">
            ...
            <div class="grow hover_2" >
                <a href="{{url('/panorama-listing/bathroom')}}">
            ...
            <div class="grow hover_2" >
                <a href="{{url('/panorama-listing/prayer-room')}}">
            ...
            <div class="grow hover_2" >
                <a href="{{url('/panorama-listing/outdoor')}}">
            ...
            <div class="grow hover_2">
                <a href="{{url('/panorama-listing/commercial')}}">
