    ...
    <div class="onLoadWrapper" style="display: none;">
        <div class="container-fluid mt-2 desktop-div" style="padding-right: 2px;">
            <div class="grow hover_1 first_width hover_2">
                <a href="javascript:void(0);" onclick="fetchCategory('livingroom','3d');">
            ...
            <div class="grow hover_2">
                <a href="javascript:void(0);" onclick="fetchCategory('bedroom','3d');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('kitchen','3d');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('bathroom','3d');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('prayer-room','3d');">
            ...
            <div class="grow hover_2" >
                <a href="javascript:void(0);" onclick="fetchCategory('outdoor','3d');">
            ...
            <div class="grow hover_2">
                <a href="javascript:void(0);" onclick="fetchCategory('commercial','3d');">
