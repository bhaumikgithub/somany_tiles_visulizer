...
function enableSelectedRooms() {
    ...
    if (checkedItems.length > 0) {
        window.$('#roomsForm').attr('action', '/panoramas/enable');
...
function disableSelectedRooms() {
    ...
    var checkedItems = getCheckedRoomsArray();
    if (checkedItems.length > 0) {
        window.$('#roomsForm').attr('action', '/panoramas/disable');
        window.$('#roomsFormSelectedRooms').val(JSON.stringify(checkedItems));
...
function deleteSelectedRooms() {
    ...
    var checkedItems = getCheckedRoomsArray();
    if (checkedItems.length > 0) {
        window.$('#roomsForm').attr('action', '/panoramas/delete');
        window.$('#roomsFormSelectedRooms').val(JSON.stringify(checkedItems));
...
<div id="addRoomFormBlock" class="panel-body" style="display: none;">
  <form id="addRoomForm" action="/panorama/add" method="POST" enctype="multipart/form-data" class="form-horizontal">
    {{ csrf_field() }}
...
{{--    </div>--}}
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-6">
        <textarea rows="4" name="surfaces" id="form-room-tiledSurfaces" class="form-control code-font" placeholder="JSON array of objects" required></textarea>
      </div>
    </div>
...
<div id="updateRoomFormBlock" class="panel-body" style="display: none;">
  <form id="updateRoomForm" action="/panorama/update" method="POST" enctype="multipart/form-data" class="form-horizontal">
    {{ csrf_field() }}
...
{{--    </div>--}}
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-6">
        <textarea rows="4" name="surfaces" id="form-update-room-tiledSurfaces" class="form-control code-font" placeholder="JSON array of objects" required></textarea>
      </div>
    </div>
